...
class Joint {
   public:
    ...
    GfMatrix4f get_local_transform()
    {
        return local_transform_;
    }
    GfMatrix4f get_world_transform()
    {
        return world_transform_;
    }
    GfMatrix4f get_bind_transform()
    {
...
class JointTree {
   public:
    ...
    shared_ptr<Joint> get_root()
    {
        return root_;
    }
    shared_ptr<Joint> get_joint(int idx)
    {
        return joints_[idx];
    }
...
class Animator {
   public:
    ...
    Animator(const shared_ptr<MeshComponent> mesh, const shared_ptr<SkelComponent> skel);
